// produce a new object called var report.
...
// - Whats the balance of all non-active accounts vs. the balance of all accounts
  var profiles = [
  {
...
var report ={
  "all_profiles": totalNumberOfProfiles,
  "all_active_profiles": activeProfiles,
  "sum_total_of_all_accounts": sumOfAllAccounts,
  "average_of_balance_per_user": averageBalancePerUser,
  "average_age_per_user": averageOfAllAges,
...
for (var i = profiles.length - 1; i >= 0; i--) {
 ...
 var totalNumberOfProfiles = profiles.forEach(function(element,index){
 console.log("There are " + profiles.length + " profiles")
  });
// ---------------------------------------------------
 var activeProfiles = profiles.forEach(function(element,index){
  if(element.isActive == true) {
    console.log("There are 9 " +  "active profiles")
    }
  });
// ------------------------------------------------------
function getAmount(string){
  ...
  var numbersOnly = parseFloat(string);
  return numbersOnly;
}
...
//------------------------------------------------------------
var averageBalancePerUser = console.log(sumOfAllAccounts / profiles.length);

//-------------------------------------------------------
function ageOnly (string){
  var numbersOnly = parseInt(string);
  return numbersOnly;
}
var sumOfAllAges = 0;
...
profiles.forEach(function(element,index){
  ...
  sumOfAllAges += ageOnly(element.age);
 ...
 var averageOfAllAges = console.log(sumOfAllAges / profiles.length )
//-------------------------------------------------------
profiles.forEach(function(element,index){
if (element.eyeColor == "blue" || "hazel" || "brown" || "green") {
